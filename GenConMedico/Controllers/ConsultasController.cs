...
namespace GenConMedico.Controllers
{
    public class ConsultasController : Controller
    {
        ...
        public ConsultasController(GenConMedContext context, IValidator<AdicionarConsultaViewModel> adicionarConsultaValidator, IValidator<EditarConsultaViewModel> editararConsultaValidator)
        {
            _context = context;
