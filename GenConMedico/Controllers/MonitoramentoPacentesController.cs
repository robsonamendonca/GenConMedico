...
namespace GenConMedico.Controllers
{
    ...
    public class MonitoramentoPacentesController : Controller
    {
        ...
        public MonitoramentoPacentesController(GenConMedContext context, IValidator<AdicionarMonitoramentoViewModel> adicionarMonitoramentoValidator, IValidator<EditarMonitoramentoViewModel> editarMonitoramentoValidator)
        {
            _context = context;
